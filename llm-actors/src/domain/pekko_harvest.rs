...
pub fn default_slot_challenges() -> Vec<SlotChallenge> {
    vec![
        ...
        body_chal!(
            ...
            "if score >= 90 { \"A\" } else if score >= 60 { \"P\" } else { \"F\" }",
        ...
        body_chal!(
            ...
            "todo!(\"letter grade A/P/F\")",
            "if score >= 90 { \"A\" } else if score >= 60 { \"P\" } else { \"F\" }",
            "grade(score): A if >=90 else P if >=60 else F. Body only replacing todo!(\"letter grade A/P/F\").\n",
        ...
        body_chal!(
            ...
            "todo!(\"letter grade A/P/F\")",
            "if score >= 90 { \"A\" } else if score >= 60 { \"P\" } else { \"F\" }",
            "grade 본문만: 90 이상 A, 60 이상 P, 아니면 F. todo!만 교체.\n",
...
mod tests {
    ...
    fn f6_golds_are_short_bodies() {
        ...
        for c in &f6 {
            ...
            // v10 was multi-arm match / for-loop accumulators — keep this step short.
            assert!(
                !c.gold_body.contains("for n in")
                    && !c.gold_body.contains("let mut acc")
                    && !c.gold_body.contains("s if s >="),
